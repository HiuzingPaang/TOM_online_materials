function fitmodel_mi_prepare(irun)
...
% run model
para_loop1 = 0.01:0.01:0.99;
ind = 0;
runmi = nan(length(para_loop1)*length(para_loop1),3+18+2+4,nsub);
if irun == 1
    rng(300);
    for p = para_loop1
        tic
...
save(['/seastor/a853898293/analysis/model_simulation/fitmodel_mi_prepa_run_',num2str(irun),'.mat'],'runmi');
end