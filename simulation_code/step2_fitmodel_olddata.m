function step2_fitmodel_olddata(irun,ipart)

%% load data
load(['/seastor/a853898293/analysis/data_mi_run',num2str(irun),'.mat'],'runmi');

%% fit the mi with Pu's real data
ncolumn = 4:21;
...
save(['/seastor/a853898293/analysis/data_FitOldData_run',num2str(irun),'_part',num2str(ipart),'.mat'],...
    'crit_glm','crit_glmm');
