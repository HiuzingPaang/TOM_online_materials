function recovery_model_run2(irun_simulate)
...
load(['/seastor/a853898293/analysis/model_simulation/data_mi_run_',num2str(irun),'_weight_',num2str(w_sel),'.mat'],'runmi');
for i1 = 1:length(para_loop1)
    for i2 = 1:length(para_loop1)
        ...
        if irun_simulate==2
            all_bhv = simulate_mi(irun_simulate,para_loop1(i1),para_loop1(i2),w_sel);
        elseif irun_simulate==1
